  ...
  <section class="bg-white rounded-2xl shadow-sm p-6 mb-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <div class="border-2 border-slate-200 rounded-xl p-5 hover:border-slate-300 transition">
        ...
        <button class="w-full px-4 py-2 bg-slate-900 text-white rounded-lg text-sm font-medium hover:opacity-90 transition">
          Export CSV
        </button>
      </div>
    ...
    <div class="space-y-4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <select class="w-full px-4 py-3 border-2 border-slate-300 rounded-xl focus:ring-2 focus:ring-slate-900 focus:border-transparent">
            ...
            <option>Stores Only</option>
            <option>Items Only</option>
            <option>Platform Status</option>
            <option>Historical Logs</option>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input type="date" class="w-full px-4 py-3 border-2 border-slate-300 rounded-xl focus:ring-2 focus:ring-slate-900 focus:border-transparent">
        </div>
      ...
      <div>
        ...
        <div class="flex gap-3">
          <label class="flex items-center gap-2 px-4 py-3 border-2 border-slate-300 rounded-xl cursor-pointer hover:border-slate-400 transition">
            <input type="checkbox" class="form-checkbox h-5 w-5 text-slate-900 rounded" checked>
      ...
      <div class="flex items-center gap-4 p-4 bg-slate-50 rounded-xl">
        <input type="checkbox" class="form-checkbox h-5 w-5 text-slate-900 rounded">
        <div class="flex-1">
