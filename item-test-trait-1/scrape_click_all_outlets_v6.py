...
Version 6: Click the correct dropdown element with cursor-pointer class
"""
...
# Log file path
LOG_FILE = "item-test-trait-1/scrape_click_outlets_v6.log"
...
with sync_playwright() as p:
    ...
    log("="*70)
    log("STARTING OUTLET CLICKING TEST V6")
    log("="*70)
    ...
    if not ensure_group_view(page):
        ...
        page.screenshot(path="item-test-trait-1/failed_group_view_v6.png")
        browser.close()
        sys.exit(1)

    # Take screenshot of starting state
    page.screenshot(path="item-test-trait-1/step1_group_view_v6.png")
    log("Screenshot saved: step1_group_view_v6.png\n")
    ...
    screenshot_path = "item-test-trait-1/all_outlets_clicked_v6.png"
